...
This guide deploys **THE WORKSHOP v9.0.1** on a single Amazon Lightsail Ubuntu instance using:
...
You should receive JSON reporting a healthy application and version `9.0.1`.
...
sudo -u workshop git -C /opt/the-workshop checkout v9.0.1
