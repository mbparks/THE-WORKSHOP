...
This guide deploys **THE WORKSHOP v5.8.2** on a single Amazon Lightsail Ubuntu instance using:
...
You should receive JSON reporting a healthy application and version `5.8.2`.
...
sudo -u workshop git -C /opt/the-workshop checkout v5.8.2
