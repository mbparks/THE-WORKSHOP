...
This guide deploys **THE WORKSHOP v3.5.6** on a single Amazon Lightsail Ubuntu instance using:
...
You should receive JSON reporting a healthy application and version `3.5.6`.
...
sudo -u workshop git -C /opt/the-workshop checkout v3.5.6
