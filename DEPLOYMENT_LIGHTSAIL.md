...
This guide deploys **THE WORKSHOP v4.0.0** on a single Amazon Lightsail Ubuntu instance using:
...
You should receive JSON reporting a healthy application and version `4.0.0`.
...
sudo -u workshop git -C /opt/the-workshop checkout v4.0.0
