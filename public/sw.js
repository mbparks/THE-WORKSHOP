const CACHE='workshop-v8.0.11';
const SHELL=['/','/index.html','/styles.css','/app.js','/manifest.webmanifest','/icon.svg','/workshop-mark.svg','/icon-192.png','/icon-512.png','/icon-maskable-192.png','/icon-maskable-512.png','/apple-touch-icon.png','/favicon.ico','/safari-pinned-tab.svg','/craft-mark.svg','/craft-default-wood.png','/craft-apprentice.png','/craft-journeyman.png','/craft-master.png'];
