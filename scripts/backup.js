...
fs.writeFileSync(path.join(dir,'manifest.json'),JSON.stringify({createdAt:new Date().toISOString(),version:'3.5.1',database:'workshop.sqlite',uploads:'uploads'},null,2));
console.log(dir);
