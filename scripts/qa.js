...
const checks=[
  ...
  ,['Reddit community link exists site-wide',html.includes('https://www.reddit.com/r/GreenShoeWorkshop/')&&app.includes('https://www.reddit.com/r/GreenShoeWorkshop/')&&html.includes('>REDDIT <')&&app.includes('>REDDIT <')]
