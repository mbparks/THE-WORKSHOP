...
const checks=[
  ...
  ,['Unfinished work is integrated into Project and Make Together surfaces',server.includes('unfinished,commons,comments')&&app.includes('id="project-unfinished"')&&app.includes('unfinished-public-section')]
  ...
  ,['Commons is integrated into existing Workshop surfaces',server.includes('commons,comments')&&app.includes("route==='commons'")&&app.includes('id="project-commons"')&&app.includes('commons-public-section')&&app.includes('crew-commons')]
  ...
  ,['v10.2 capability flag is published',server.includes('commons:true')&&app.includes("version:'10.2.0'")]
