...
const checks=[
  ...
  ,['v10.5 capability flag and version markers are published',server.includes('localQuests:true')&&server.includes("const APP_VERSION = '10.5.0'")&&pkg.version==='10.5.0'&&read('public/index.html').includes('v10.5.0')&&read('public/manifest.webmanifest').includes('10.5.0')&&read('public/sw.js').includes('workshop-v10.5.0')]
